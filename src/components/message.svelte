...
<section>
  ...
  >
    ...
    <button
      ...
      class="btn m-2 btn-outline btn-secondary font-bold italic"
      >Send &rarr;</button
    >
  </form>
  {#if submit}
    ...
    {:then data}
      ...
      >
        <div>
          ...
          >
          <span
            >Berhasil mengirim pesan, tolong refresh halaman ini untuk
            melihatnya!</span
          >
        </div>
      </div>
  ...
  <div>
    ...
    {:then data}
      {#each data as comment}
        <div
          class="mockup-code card w-96 my-2 mx-auto bg-base-100/60 shadow-xl"
        >
